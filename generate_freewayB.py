...
#FreewayB的lane information dictionary
lane_info_freewayB = {
    0: {
        "direction": "east-west",
        "left_adjacent_lane": [1],
        "right_adjacent_lane": None,
        "front_lane":[1],
        "available_actions": ["Move straight, change to left lane 1"]
    },
    1: {
        "direction": "east-west",
        "left_adjacent_lane": [2],
        "right_adjacent_lane": [0],
        "available_actions": ["Move straight, change to right lane 0, change to left lane 2"]
    },
    2: {
        "direction": "east-west",
        "left_adjacent_lane": None,
        "right_adjacent_lane": [1],
        "available_actions": ["Move straight, change to right lane 1"]
    },
    3: {
        "direction": "west-east",
        "left_adjacent_lane": None,
    ...
    4: {
        ...
        "right_adjacent_lane": [5],
        "available_actions": ["Move straight, change to right lane 5, change to left lane 3"]
    },
    5: {
        "direction": "west-east",
        "left_adjacent_lane": [4],
        "right_adjacent_lane": None,
        "available_actions": ["Move straight, change to left lane 3"]
    }
}
...
def generate_freewayB(json_path, lane_info=lane_info_freewayB, frame_step=5, start_frame=None, end_frame=None):
